    ...
    public class ProfileStorageTests
    {
        private static ProfileData testProfileData = new ProfileData
        {
            ...
            Environments = new[]
            {
                new AzureEnvironmentData
                {
                    ...
                    ServiceEndpointActiveDirectoryResourceUri = "https://some.ActiveDirectory.azure/"
                },
                new AzureEnvironmentData
                {
                    ...
                    ServiceEndpointActiveDirectoryResourceUri = "https://other.ActiveDirectory.azure/"
                }
            },
            Subscriptions = new []
            {
        ...
        public void SavingWritesProfileDataToStore()
        {
            ...
            profile.AddEnvironment(new WindowsAzureEnvironment
            {
                ...
                ServiceEndpointActiveDirectoryResourceUri = sourceEnv.ServiceEndpointActiveDirectoryResourceUri
            });
        ...
        private void AssertEqual(AzureEnvironmentData expected, AzureEnvironmentData actual)
        {
            ...
            Assert.AreEqual(expected.ServiceEndpointActiveDirectoryResourceUri,
                actual.ServiceEndpointActiveDirectoryResourceUri);
        }
