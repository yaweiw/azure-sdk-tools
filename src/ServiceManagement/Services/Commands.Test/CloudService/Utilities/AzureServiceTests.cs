    ...
    public class AzureServiceTests: TestBase
    {
        ...
        public void TestResolveRuntimePackageUrls()
        {
            ...
            using (FileSystemHelper files = new FileSystemHelper(this) { EnableMonitoring = true })
            {
                ...
                RuntimePackageHelper.SetRoleRuntime(testService.Components.Definition, matchWebRoleName, testService.Paths, version: "0.8.3");
                RuntimePackageHelper.SetRoleRuntime(testService.Components.Definition, matchWorkerRoleName, testService.Paths, version: "0.8.3");
