...
namespace Microsoft.WindowsAzure.Commands.ServiceManagement.Test.FunctionalTests.IaasCmdletInfo.ILB
{
    ...
    public class AddAzureInternalLoadBalancerCmdletInfo: CmdletsInfo
    {

        public AddAzureInternalLoadBalancerCmdletInfo(string internalLoadBalancerName, string serviceName, string subnetName, IPAddress staticVNetIPAddress)
        {
            this.cmdletName = Utilities.AddAzureInternalLoadBalancerCmdletName;
            //mandatory parameter
