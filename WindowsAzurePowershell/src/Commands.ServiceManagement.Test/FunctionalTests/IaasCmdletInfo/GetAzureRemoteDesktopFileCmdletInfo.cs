...
namespace Microsoft.WindowsAzure.Commands.ServiceManagement.Test.FunctionalTests.IaasCmdletInfo
{
    ...
    public class GetAzureRemoteDesktopFileCmdletInfo : CmdletsInfo
    {
        ...
        {
            this.cmdletName = Utilities.GetAzureRemoteDesktopFileCmdletName;
            this.cmdletParams.Add(new CmdletParam("ServiceName", serviceName));
            this.cmdletParams.Add(new CmdletParam("Name", vmName));
            this.cmdletParams.Add(new CmdletParam("LocalPath", localPath));
            if (launch)
            {
                this.cmdletParams.Add(new CmdletParam("Launch"));
            }
