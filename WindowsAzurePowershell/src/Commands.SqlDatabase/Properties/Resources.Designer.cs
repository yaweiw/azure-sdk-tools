...
namespace Microsoft.WindowsAzure.Commands.SqlDatabase.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The client model does not match the server model. While the current set of Cmdlets may continue to work, it is recommended that you update to the latest version of Windows Azure PowerShell to ensure full compatibility..
        /// </summary>
