...
namespace Microsoft.WindowsAzure.Commands.SqlDatabase.Database.Cmdlet
{
    ...
    public abstract class GetAzureSqlDatabaseBase : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            ProcessWithContext(context, databaseName);
        }
        ...
        protected abstract void OperationOnContext(IServerDataServiceContext context, string databaseName);

        protected abstract void OperationOnContext(IServerDataServiceContext context);
        ...
        private void ProcessWithContext(IServerDataServiceContext context, string databaseName)
        {
            try
            {
                if (databaseName != null)
                {
                    ...
                    OperationOnContext(context, databaseName);
                }
                else
                {
                    // No name specified, retrieve all databases in the server
                    OperationOnContext(context);
                }
            }
            catch (Exception ex)
            {
