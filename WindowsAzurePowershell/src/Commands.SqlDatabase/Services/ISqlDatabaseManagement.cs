...
namespace Microsoft.WindowsAzure.Management.SqlDatabase.Services
{
    ...
    public partial interface ISqlDatabaseManagement
    {
        ...
        [OperationContract(AsyncPattern = true)]
        [WebInvoke(Method = "GET",
            // ximchen TODO: Confirm with James whether this URI is correct
            UriTemplate = @"{subscriptionId}/services/sqlservers/servers/{serverName}/databaseoperations?databaseName={databaseName}")]
        IAsyncResult BeginGetDatabasesOperations(
            string subscriptionId,
            string serverName,
            AsyncCallback callback,
            object state);
        ...
        /// <param name="asyncResult">The web request result</param>
        /// <returns>A list of SqlDatabase objects.</returns>
        DatabaseOperationListResponse EndGetDatabasesOperations(IAsyncResult asyncResult);

        /// <summary>
        /// Gets a list of database operations for a given server or a database.
        /// </summary>
        /// <param name="subscriptionId">The subscription Id that the server belongs to</param>
        /// <param name="serverName">The name of the server the database belongs to</param>
        /// <param name="databaseName">The name of the database to retrieve</param>
        ...
        [WebInvoke(Method = "GET",
            UriTemplate = @"{subscriptionId}/services/sqlservers/servers/{serverName}/databaseoperations?databaseName={databaseName}")]
        IAsyncResult BeginGetDatabaseOperations(
            string subscriptionId,
            string serverName,
            string databaseName,
            AsyncCallback callback,
        ...
        /// <summary>
        /// Finishes the Async web request and gets the database's operations
        /// </summary>
        /// <param name="asyncResult">The web request result</param>
        /// <returns>A <see cref="DatabaseOperationListResponse"/> representing the database's operations</returns>
        DatabaseOperationListResponse EndGetDatabaseOperations(IAsyncResult asyncResult);
    }
}
