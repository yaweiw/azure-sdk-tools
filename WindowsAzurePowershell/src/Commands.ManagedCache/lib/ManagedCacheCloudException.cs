...
namespace Microsoft.Azure.Management.ManagedCache
{
        ...
        : CloudException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ManagedCacheeCloudException class.
        /// </summary>
        /// <param name="message">The exception message.</param>
        public ManagedCacheCloudException(string message)
            : this(message, null)
        {
        }

        /// <summary>
        /// Initializes a new instance of the ManagedCacheCloudException class.
        /// </summary>
        /// <param name="message">The exception message.</param>
        /// <param name="innerException">Inner exception.</param>
        public ManagedCacheCloudException(string message, Exception innerException)
            ...
            Exception innerException = null)
        {
            ...
            ManagedCacheCloudException exception = new ManagedCacheCloudException(exceptionMessage, innerException);
