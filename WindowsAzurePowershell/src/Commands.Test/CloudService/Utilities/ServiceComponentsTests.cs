...
namespace Microsoft.WindowsAzure.Commands.Test.CloudService.Utilities
{
    ...
    public class ServiceComponentsTests : TestBase
    {
        ...
        public void ServiceComponentsTest()
        {
            ...
            ServiceComponents components = new ServiceComponents(new PowerShellCloudServicePathInfo(serviceName));
        ...
        {
            newServiceCmdlet.NewAzureServiceProcess(Directory.GetCurrentDirectory(), serviceName);
            PowerShellCloudServicePathInfo paths = new PowerShellCloudServicePathInfo(serviceName);
