...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.Certificates
{
    ...
    public class RemoveAzureCertificate : ServiceManagementBaseCmdlet
    {
        ...
        {
            ExecuteClientActionInOCS(null, CommandRuntime.ToString(), s => ServiceManagementExtensionMethods.DeleteCertificateTask(this.Channel, s, this.ServiceName, this.ThumbprintAlgorithm, this.Thumbprint), WaitForOperation);
        }
