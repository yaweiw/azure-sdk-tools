...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.HostedServices
{
    ...
    public class SetAzureWalkUpgradeDomainCommand : ServiceManagementBaseCmdlet
    {
        ...
        internal void ExecuteCommand()
        {
            ...
            ExecuteClientActionInOCS(null, CommandRuntime.ToString(), s => this.Channel.WalkUpgradeDomainBySlotTask(s, this.ServiceName, this.Slot, walkUpgradeDomain), WaitForOperation);
        }
