...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.HostedServices
{
    ...
    public class SetAzureServiceCommand : ServiceManagementBaseCmdlet
    {
        ...
        protected override void OnProcessRecord()
        {
            ...
            ExecuteClientActionInOCS(updateHostedServiceInput, CommandRuntime.ToString(), s => this.Channel.UpdateHostedServiceTask(s, this.ServiceName, updateHostedServiceInput), WaitForOperation);
        }
    }
}
