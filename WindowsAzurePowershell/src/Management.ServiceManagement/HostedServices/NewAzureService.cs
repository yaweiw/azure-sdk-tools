...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.HostedServices
{
    ...
    public class NewAzureServiceCommand : ServiceManagementBaseCmdlet
    {
        ...
        public void ExecuteCommand()
        {
            ...
            ExecuteClientActionInOCS(createHostedServiceInput, CommandRuntime.ToString(), s => this.Channel.CreateHostedServiceTask(s, createHostedServiceInput), WaitForOperation);
        }
