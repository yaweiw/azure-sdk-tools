...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.IaaS
{
    ...
    public class UpdateAzureVMCommand : IaaSDeploymentManagementCmdletBase
    {
        ...
        internal override void ExecuteCommand()
        {
            ...
            ExecuteClientActionInOCS(role, CommandRuntime.ToString(), s => this.Channel.UpdateRoleTask(s, this.ServiceName, CurrentDeployment.Name, this.Name, role), WaitForOperation);
