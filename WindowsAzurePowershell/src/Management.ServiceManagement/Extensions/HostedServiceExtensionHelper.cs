...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.Extensions
{
    ...
    {
        static internal bool ExistLegacySetting(Deployment deployment, string legacySettingAttributeName)
        {
            bool enabled = false;
                    ...
                    if (xmlNodeList.Count > 0)
                    {
                        ...
                        foreach (XmlNode childNode in parentNode)
                        {
                            if (childNode.Attributes["name"] != null && childNode.Attributes["value"] != null)
                            {
                                ...
                                if (nameStr.Equals(legacySettingAttributeName))
                                {
        ...
        static internal bool Exists(ExtensionConfiguration inConfig, string roleName, string extensionId)
        {
            ExtensionConfiguration outConfig = NewExtensionConfig(inConfig);
