...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.Extensions
{
    ...
    /// <summary>
    /// Remove Windows Azure Service Remote Desktop.
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "AzureServiceRemoteDesktop"), OutputType(typeof(ManagementOperationContext))]
    public class RemoveAzureServiceRemoteDesktopExtensionCommand : ServiceManagementBaseCmdlet
    {
        ...
        private void DisableExtension()
        {
            ...
            if (HostedServiceExtensionHelper.CheckExtension(extConfig, Roles, Channel, CurrentSubscription.SubscriptionId, ServiceName, ExtensionNameSpace, ExtensionType))
            {
