...
namespace Microsoft.WindowsAzure.Commands.Utilities.Websites.Services
{
    ...
    public interface IWebsitesServiceManagement
    {
        ...
        IAsyncResult BeginGetWebSpaces(string Name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginGetWebSpace(string Name, string name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginCreateWebSpace(string Name, bool allowPendingState, WebSpace webSpace, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginUpdateWebSpace(string Name, string name, bool allowPendingState, WebSpace webSpace, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginDeleteWebSpace(string Name, string name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginGetSubscriptionPublishingUsers(string Name,  AsyncCallback callback, object state);
        ...
        IAsyncResult BeginGetSites(string Name, string webspaceName, string propertiesToInclude, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginGetSite(string Name, string webspaceName, string name, string propertiesToInclude, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginCreateSite(string Name, string webspaceName, Site site, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginUpdateSite(string Name, string webspaceName, string name, Site site, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginDeleteSite(string Name, string webspaceName, string name, string deleteMetrics, AsyncCallback callback, object state);
        ...
        [OperationContract(AsyncPattern = true)]
        IAsyncResult BeginGetSiteConfig(string Name, string webspaceName, string name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginUpdateSiteConfig(string Name, string webspaceName, string name, SiteConfig siteConfig, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginCreateSiteRepository(string Name, string webspaceName, string name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginGetSiteRepositoryUri(string Name, string webspaceName, string name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginDeleteSiteRepository(string Name, string webspaceName, string name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginCreateDevSite(string Name, string webspaceName, string name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginGetDevSite(string Name, string webspaceName, string name, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginUpdateDevSite(string Name, string webspaceName, string name, SiteRepositoryDev repositoryDevSite, AsyncCallback callback, object state);
        ...
        IAsyncResult BeginDeleteDevSite(string Name, string webspaceName, string name, AsyncCallback callback, object state);
