...
namespace Microsoft.WindowsAzure.Commands.Utilities.CloudService
{
    ...
    public class ServiceComponents
    {
        ...
        public ServiceComponents(PowerShellCloudServicePathInfo paths)
        {
            LoadComponents(paths);
        }

        private void LoadComponents(PowerShellCloudServicePathInfo paths)
        {
        ...
        public void Save(PowerShellCloudServicePathInfo paths)
        {
