...
{
    internal class CmdletTestHelper 
    {
        ...
        public CopyBlobContext CopyAzureBlob(string source, string destination, bool overwrite)
        {
            ...
            if (result.Count == 1)
            {
                return (CopyBlobContext)result[0].BaseObject;
            }
