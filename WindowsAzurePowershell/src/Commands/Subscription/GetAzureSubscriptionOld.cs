...
namespace Microsoft.WindowsAzure.Commands.Subscription
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureSubscriptionOld", DefaultParameterSetName = "ByName"), OutputType(typeof(SubscriptionData))]
    public class GetAzureSubscriptionOldCommand : ServiceManagementBaseCmdlet
    {
