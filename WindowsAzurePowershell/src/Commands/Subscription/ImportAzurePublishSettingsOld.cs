...
namespace Microsoft.WindowsAzure.Commands.Subscription
{
    ...
    /// </summary>
    [Cmdlet(VerbsData.Import, "AzurePublishSettingsFileOld"), OutputType(typeof (string))]
    public class ImportAzurePublishSettingsOldCommand : CmdletBase, IModuleAssemblyInitializer
    {
