...
namespace Microsoft.WindowsAzure.Commands.Subscription
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Select, "AzureSubscriptionOld", DefaultParameterSetName = "Set"), OutputType(typeof(bool))]
    public class SelectAzureSubscriptionOldCommand : PSCmdlet
    {
