...
namespace Microsoft.WindowsAzure.Commands.Test.Utilities.Common
{
    ...
    public static class AzureAssert
    {
        ...
        public static void AreEqualServicePathInfo(PowerShellCloudServicePathInfo expected, PowerShellCloudServicePathInfo actual)
        {
        ...
        public static void AreEqualServicePathInfo(string cloudConfig, string cloudPackage, string def, string localConfig, string localPackage, string rootPath, string settings, PowerShellCloudServicePathInfo actual)
        {
            throw new NotImplementedException();
        }

        public static void AreEqualServicePathInfo(string rootPath, PowerShellCloudServicePathInfo actual)
        {
        ...
        {
            ServiceComponents components = new ServiceComponents(new PowerShellCloudServicePathInfo(serviceRootPath));
