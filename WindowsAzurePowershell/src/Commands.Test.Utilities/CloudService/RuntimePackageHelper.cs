...
namespace Microsoft.WindowsAzure.Commands.Test.Utilities.CloudService
{
    ...
    public class RuntimePackageHelper
    {
        ...
        public static bool SetRoleRuntime(ServiceDefinition definition, string roleName, PowerShellCloudServicePathInfo path, string version = null, string overrideUrl = null)
        {
            bool changed = false;
