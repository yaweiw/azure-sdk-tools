...
namespace Microsoft.WindowsAzure.Commands.ServiceManagement.Preview.Network
{
    ...
    public class NewAzureReservedIPCmdlet : ServiceManagementBaseCmdlet
    {
        ...
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = ReserveNewIPParamSet, HelpMessage = "Reserved IP Label.")]
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = ReserveInUseIPParamSet, HelpMessage = "Reserved IP Label.")]
        [ValidateNotNullOrEmpty]
        public string Label
        {
            get;
