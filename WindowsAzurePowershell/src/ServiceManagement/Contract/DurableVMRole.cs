...
namespace Microsoft.Samples.WindowsAzure.ServiceManagement
{
    ...
    public partial interface IServiceManagement
    {
        ...
        IAsyncResult BeginUpdateDataDisk(
            string subscriptionID,
            string serviceName,
            string deploymentName,
            string roleName,
        ...
        IAsyncResult BeginDeleteDataDisk(
            string subscriptionID,
            string serviceName,
            string deploymentName,
            string roleName,
        ...
        IAsyncResult BeginDownloadRDPFile(
            string subscriptionID,
            string serviceName,
            string deploymentName,
            string instanceName,
    ...
    {
        public static void CaptureRole(
        ...
        public static void ShutdownRole(
            this IServiceManagement proxy,
            string subscriptionId,
            string serviceName,
            string deploymentName,
        ...
        public static void RestartRole(
            this IServiceManagement proxy,
            string subscriptionId,
            string serviceName,
            string deploymentName,
        ...
        public static void UpdateDataDisk(
            this IServiceManagement proxy,
            string subscriptionId,
            string serviceName,
            string deploymentName,
        ...
        public static void DeleteDataDisk(
            this IServiceManagement proxy,
            string subscriptionId,
            string serviceName,
            string deploymentName,
        ...
        public static DataVirtualHardDisk GetDataDisk(
            this IServiceManagement proxy,
            string subscriptionId,
            string serviceName,
            string deploymentName,
        ...
        public static PersistentVMRole GetRole(
            this IServiceManagement proxy,
            string subscriptionId,
            string serviceName,
            string deploymentName,
        ...
        public static Stream DownloadRDPFile(
            this IServiceManagement proxy,
            string subscriptionID,
            string serviceName,
            string deploymentName,
