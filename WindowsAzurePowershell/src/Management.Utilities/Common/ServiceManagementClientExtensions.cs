namespace Microsoft.WindowsAzure.ServiceManagement
{
    ...
    public static class ServiceManagementClientExtensions
    {
        ...
        //public static void SetVirtualNetworkGatewayConfiguration(this IServiceManagement proxy, string subscriptionID, string virtualnetworkID,
        //    VirtualNetworkGatewayConfiguration gatewayConfiguration)
        //{
        //    proxy.EndSetVirtualNetworkGatewayConfiguration(proxy.BeginSetVirtualNetworkGatewayConfiguration(subscriptionID,
        //        virtualnetworkID, gatewayConfiguration, null, null));
        //}
